...
- one 4-section slide with one screenshot or diagram per section
- or a 2x2 layout: app shell, state sync, feature modules, integrated workflow

### 讲稿提示

- Use this page to show that the frontend already has real architecture, not just several isolated pages.
- The key message is that the desktop app is the product hub that connects backend capabilities into one usable workflow.
