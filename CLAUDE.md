...
ESP32-S3 + INMP441麦克风 + MAX98357A功放 + 3W喇叭 + 1.54寸ST7789屏幕(240×240) + 电源管理(TP4056+AP2114H-3.3)
...
| J3 | 屏幕FPC座 | AFC01-S12FCA-00 (12P FPC) | 1.54寸ST7789 IPS LCD连接 |
...
|------|-----------|------|
| 扬声器 | 3W 4Ω | 语音播放（接P1） |
| 显示屏 | 1.54" IPS TFT ST7789 (240×240) | 时间/天气/状态显示（FPC接J3） |
